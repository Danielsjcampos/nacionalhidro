...
async function main() {
    console.log('Seeding Equipamento Hidrojato SAP - Ultra Alta Pressao data...');
    ...
    const responsabilidadesToCreate = [
        ...
        { descricao: "Abastecimento Diesel Equipamentos", tipo: "CONTRATANTE (CLIENTE)" } // assumido como contratante por default do `-`
    ];
    ...
    if (!existingEquip) {
        ...
        console.log('Equipamento Hidrojato SAP UAP inserido com sucesso com suas responsabilidades e imagem.');
    } else {
        ...
        console.log('Equipamento Hidrojato SAP UAP já existia e foi atualizado.');
    }
}
